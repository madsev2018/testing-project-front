...
$theme_url = URI::base(true) . '/templates/'. $this->template;
$preset = json_decode($params->get('preset', 'preset1'));
...
<html lang="<?php echo $this->language; ?>" dir="<?php echo $this->direction; ?>">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template; ?>/css/template.css" type="text/css" />
            <link href="<?php echo $theme_url . '/css/presets/' . $preset->preset . '.css'; ?>" rel="stylesheet">


  </head>

  <body class="contentpane <?php echo $body_class; ?> bilder">
