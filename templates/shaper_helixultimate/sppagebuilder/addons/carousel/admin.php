                    ...
                    'sp_carousel_item' => array(
                        ...
                        'attr' => array(
                            ...
                            'module_selector' => array(
                                'type' => 'select',
                                'title' => JText::_('COM_SPPAGEBUILDER_ADDON_TYPE_MODULE'),
                                'desc' => JText::_('COM_SPPAGEBUILDER_ADDON_TYPE_MODULE_DESC'),
                                'values' => array(
                                    'sp_page_builder' => JText::_('COM_SPPAGEBUILDER_ADDON_TYPE_MODULE_SP'),
                                    'basic' => JText::_('COM_SPPAGEBUILDER_ADDON_TYPE_MODULE_BASIC'),
                                ),
                                'depends' => array('module_type' => 'module'),
                            ),
                        ),
