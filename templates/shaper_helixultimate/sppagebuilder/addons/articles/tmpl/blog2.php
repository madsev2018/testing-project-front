<?php 
      ...
      foreach ($items as $key => $item) {
       ...
       // print_r($i);
        ...
        if(!$used_masonry){
          $output .= '<div class="sppb-col-sm-'. round(12/$columns) .' '.$itemclass.'">';
        }else {
          if($columns > 0) {
           $output .= '<div class="sppb-col-sm-'. round(12/$columns) .' grid-item '.$itemclass.'">';
          }else {
           $output .= '<div class="sppb-col-sm-0 grid-item '.$itemclass.'">';
          }
        }
        ...
        $output .= '<h4 class="name-blog"><a  href="'. $item->link .'" itemprop="url">' . $item->title . '</a></h4>';
      ...
      // See all link
      if($link_articles) {
      $output .= '<div class="seealllink ' . $all_articles_btn_position_alignment . '">';
