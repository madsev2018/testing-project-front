...
$output .= '<div id="sp-top-bar" class="style-2">';
...
$output .= '<header id="sp-header" class="style-2">';
...
{
    $class1 = 'col-md-3';
    $class2 = 'd-none d-lg-block col-md-7';
}
...
$output .= '<div id="after-logo" class="col-md-2">';
$output .= '<div class="sp-column">';
