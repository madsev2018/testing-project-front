...
JHtml::stylesheet('com_convertforms/flatpickr.min.css', false, true);
JHtml::script('com_convertforms/flatpickr.js', false, true);

// Load selected theme
if ($field->theme)
{
	JHtml::stylesheet('//npmcdn.com/flatpickr/dist/themes/' . $field->theme . '.css');
}
