...
class SppagebuilderAddonGallery extends SppagebuilderAddons{
    ...
    public function css() {
        ...
        $width_sm = (isset($this->addon->settings->width_sm) && $this->addon->settings->width_sm) ? $this->addon->settings->width_sm : 200;
        $width_xs = (isset($this->addon->settings->width_xs) && $this->addon->settings->width_xs) ? $this->addon->settings->width_xs : 200;

        $height = (isset($this->addon->settings->height) && $this->addon->settings->height) ? $this->addon->settings->height : 200;
        $height_sm = (isset($this->addon->settings->height_sm) && $this->addon->settings->height_sm) ? $this->addon->settings->height_sm : 200;
        $height_xs = (isset($this->addon->settings->height_xs) && $this->addon->settings->height_xs) ? $this->addon->settings->height_xs : 200;
